...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.VooTreeVeeVuu.domain.entity.AccommodationType", "com.VooTreeVeeVuu.domain.entity.Account", "com.VooTreeVeeVuu.domain.entity.Booking", "com.VooTreeVeeVuu.domain.entity.Facility", "com.VooTreeVeeVuu.domain.entity.Hotel", "com.VooTreeVeeVuu.domain.entity.HotelFacility", "com.VooTreeVeeVuu.domain.entity.HotelImage", "com.VooTreeVeeVuu.domain.entity.Logs", "com.VooTreeVeeVuu.domain.entity.OTP", "com.VooTreeVeeVuu.domain.entity.Payment", "com.VooTreeVeeVuu.domain.entity.Rating", "com.VooTreeVeeVuu.domain.entity.Role", "com.VooTreeVeeVuu.domain.entity.Room", "com.VooTreeVeeVuu.domain.entity.RoomFacility", "com.VooTreeVeeVuu.domain.entity.RoomImage", "com.VooTreeVeeVuu.domain.entity.RoomType", "com.VooTreeVeeVuu.domain.entity.User");
