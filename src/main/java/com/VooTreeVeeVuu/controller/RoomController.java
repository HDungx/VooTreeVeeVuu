...
public class RoomController {
	...
	public ResponseEntity<GetAllRoomDTO> updateRoomImages (@PathVariable Long roomId,
	...
	public Optional<GetAllRoomDTO> updateRoomStatus (@PathVariable ("roomId") Long roomId,
	                                                 @RequestBody GetAllRoomDTO dto) {
