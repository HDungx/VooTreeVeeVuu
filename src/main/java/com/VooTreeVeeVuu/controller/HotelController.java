...
//    private ImagesUploadImpl imagesUploadUseCase;
	...
	public ResponseEntity<String> removeHotelImages (@PathVariable Long hotelId) {
		hotelService.removeAllHotelImages(hotelId);
		return ResponseEntity.ok("Hotel images deleted successfully");
	}

	@DeleteMapping ("/{hotelId}/images/{imageId}")
	public ResponseEntity<String> removeHotelImage (@PathVariable Long hotelId, @PathVariable Long imageId) {
		hotelService.removeHotelImage(hotelId, imageId);
