...
public class BookingDTO {
	...
	public BookingDTO (Long id, LocalDate checkInDate, LocalDate checkOutDate, double totalPrice, String userName,
	                   String hotelName, String roomType, String address, String city, Long hotelId, Long hotelOwnerId,
	                   Booking_status status, Integer numOfRoom, Integer numOfGuest, LocalDate bookingDate) {
		this.id = id;
